...
class Submit(object):
    ...
    def _submit_single(self, loop_index, loop_item):
        ...
        jobstring = "python /home/yuanlq/software/midwayjob/build_peaks.py %s %s"%(loop_item, loop_index)
        print(jobstring)
...
loop_over = glob.glob('/project2/lgrandi/yuanlq/shared/midway_corrupted/20230826/chunks/*')
