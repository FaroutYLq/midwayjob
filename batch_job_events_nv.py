...
class Submit(object):
    ...
    def _submit_single(self, loop_index, loop_item):
        ...
        jobstring = "python /home/yuanlq/software/midwayjob/process_events_nv.py %s"%(run_id)
        print(jobstring)

        # Modify here for the log name
        utilix.batchq.submit_job(
            jobstring, log='/home/yuanlq/.tmp_job_submission/process_events_nv%s.log'%(run_id), partition='xenon1t', qos='xenon1t',
