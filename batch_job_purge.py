...
class Submit(object):
    ...
    def _submit_single(self, loop_index, loop_item):
        ...
        jobstring = "python /home/yuanlq/software/midwayjob/purge_runlist.py %s %s"%(loop_item, loop_index)
        print(jobstring)

        # Modify here for the log name
        utilix.batchq.submit_job(
            jobstring, log='/home/yuanlq/.tmp_job_submission/purge_midway_v11/purge_%s.log'%(loop_index), 
            partition='xenon1t', qos='xenon1t',
            account='pi-lgrandi', jobname=jobname,
            dry_run=False, mem_per_cpu=2500,
...
loop_over = glob.glob('/home/yuanlq/v11_reprocessing/segmented/*')
